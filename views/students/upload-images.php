                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <ul class="mb-0">
                            ...
                            <li>Images will be saved to: <code>assets/img/Studnet_profile/</code></li>
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($dirExists): ?>
                                <div class="d-flex align-items-center text-success mb-2">
                                    ...
                                    <span>Image directory exists: <code><?php echo htmlspecialchars($targetDir ?? 'assets/img/Studnet_profile'); ?></code></span>
                                </div>
                            <?php else: ?>
