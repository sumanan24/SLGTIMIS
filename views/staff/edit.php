        ...
        <div class="col-lg-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-edit me-2"></i>Edit Staff</h5>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
                    ...
                    <form method="POST" action="<?php echo APP_URL; ?>/staff/edit?id=<?php echo urlencode($staff['staff_id']); ?>">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="staff_epf" name="staff_epf" 
                                       value="<?php echo htmlspecialchars($staff['staff_epf']); ?>" 
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="staff_dob" name="staff_dob" 
                                       value="<?php echo htmlspecialchars($staff['staff_dob'] ?? ''); ?>" required>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="staff_date_of_join" name="staff_date_of_join" 
                                       value="<?php echo htmlspecialchars($staff['staff_date_of_join'] ?? ''); ?>" required>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="staff_gender" name="staff_gender" required>
                                    ...
                                    <option value="Male" <?php echo ($staff['staff_gender'] ?? '') === 'Male' ? 'selected' : ''; ?>>Male</option>
                                    <option value="Female" <?php echo ($staff['staff_gender'] ?? '') === 'Female' ? 'selected' : ''; ?>>Female</option>
                                    <option value="Transgender" <?php echo ($staff['staff_gender'] ?? '') === 'Transgender' ? 'selected' : ''; ?>>Transgender</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" id="staff_position" name="staff_position" required>
                                    ...
                                    <?php foreach ($roles as $role): ?>
                                        <option value="<?php echo htmlspecialchars($role['staff_position_type_id']); ?>" 
                                                <?php echo ($staff['staff_position'] === $role['staff_position_type_id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="staff_type" name="staff_type" required>
                                    <option value="">Select</option>
                                    <option value="Permanent" <?php echo ($staff['staff_type'] ?? '') === 'Permanent' ? 'selected' : ''; ?>>Permanent</option>
                                    <option value="On Contract" <?php echo ($staff['staff_type'] ?? '') === 'On Contract' ? 'selected' : ''; ?>>On Contract</option>
                                    <option value="Visiting Lecturer" <?php echo ($staff['staff_type'] ?? '') === 'Visiting Lecturer' ? 'selected' : ''; ?>>Visiting Lecturer</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="staff_status" name="staff_status">
                                    <option value="Working" <?php echo ($staff['staff_status'] ?? '') === 'Working' ? 'selected' : ''; ?>>Working</option>
                                    <option value="Terminated" <?php echo ($staff['staff_status'] ?? '') === 'Terminated' ? 'selected' : ''; ?>>Terminated</option>
                                    <option value="Resigned" <?php echo ($staff['staff_status'] ?? '') === 'Resigned' ? 'selected' : ''; ?>>Resigned</option>
                                </select>
                            </div>
                        </div>
