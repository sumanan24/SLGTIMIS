        ...
        <div class="card-body">
            ...
            <div class="card mb-4 border-0" style="background-color: #f8f9fa;">
                <div class="card-body">
                    ...
                    <form method="GET" action="<?php echo APP_URL; ?>/admin/users" id="filterForm">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-select" id="lock_status" name="lock_status">
                                    <option value="">All</option>
                                    <option value="locked" <?php echo (isset($filters['lock_status']) && $filters['lock_status'] == 'locked') ? 'selected' : ''; ?>>Locked</option>
                                    <option value="unlocked" <?php echo (isset($filters['lock_status']) && $filters['lock_status'] == 'unlocked') ? 'selected' : ''; ?>>Unlocked</option>
                                </select>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo APP_URL; ?>/admin/users" class="btn btn-secondary">
                                    <i class="fas fa-times me-1"></i>Clear
                                </a>
                                <?php if (!empty($filters)): ?>
                                    <span class="badge bg-info ms-2">
                                        <?php echo count($users); ?> of <?php echo $totalUsers ?? count($users); ?> users shown
                                    </span>
                                <?php else: ?>
                                    <span class="badge bg-info ms-2">
                                        Total: <?php echo $totalUsers ?? count($users); ?> users
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($user['account_locked']) && $user['account_locked'] == 1): ?>
