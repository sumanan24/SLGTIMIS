...
<div class="container-fluid px-3 px-md-4 devices-page-wrap">
    ...
    <?php if (!empty($activeAssignment)): ?>
    <div class="alert alert-info">Currently assigned to <strong><?php echo $e($activeAssignment['staff_name'] ?? ''); ?></strong> since <?php echo $e($activeAssignment['issue_date'] ?? ''); ?>. Submitting will reassign and close the previous record.</div>
    <?php endif; ?>
