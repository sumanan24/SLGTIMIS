            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small mb-3">
                        Same layout as the device dashboard: one row per day per employee, with check-in / check-out from device punches.
                        The employee list only includes people who have at least one punch in the <strong>selected month</strong>.
                    </p>
