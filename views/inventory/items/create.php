<div class="container-fluid px-3 py-3" style="max-width:720px;">
    ...
    <form method="post" action="<?php echo APP_URL; ?>/inventory/items/create" class="card shadow-sm border-0 p-3">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="item_code" class="form-control" required maxlength="100">
        </div>
        <div class="mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="unit" class="form-control" maxlength="50" placeholder="e.g. pcs, box">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
