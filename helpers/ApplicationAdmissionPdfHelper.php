...
class ApplicationAdmissionPdfHelper {
    ...
    public const INSTITUTE_POST_FROM_PHONE = '';
    ...
    public static function wrapPostalAdmissionCardsDocument(string $bodyHtml): string {
        $css = '@page{margin:10mm;size:A4 portrait;}'
            ...
            . '.mail-phone{font-size:11px;font-weight:600;margin-top:4px;color:#0f172a;}'
            ...
            . '.certified-by-text{font-size:11px;line-height:1.35;font-weight:600;text-align:center;margin:0 0 5px;color:#0f172a;}'
