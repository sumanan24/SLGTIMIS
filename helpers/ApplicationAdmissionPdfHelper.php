...
class ApplicationAdmissionPdfHelper {
    ...
    private static function postalAdmissionCardStylesheet(): string {
        return ''
            ...
            . 'table.iv-choices{width:100%;border-collapse:collapse;}'
            . 'table.iv-choices td{border:0.5pt solid #bbb;padding:1.1mm 1.8mm;font-size:8.5pt;vertical-align:middle;}'
            . '.iv-ch-ord{width:22%;}'
            . '.iv-ch-flag{width:20%;text-align:center;font-size:7.5pt;letter-spacing:0.02em;text-transform:uppercase;}'
