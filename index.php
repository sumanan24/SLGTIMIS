...
$publicNoTimeoutUris = ['login', 'home', '', 'level04application', 'level05application', 'student-application/api/check-application', 'student-application/api/insert-draft', 'student-application/api/save-progress', 'student-application/api/departments', 'student-application/api/courses'];
